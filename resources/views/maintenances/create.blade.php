        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div
                ...
                <div class="p-6 border-b border-gray-200 dark:border-gray-700 flex items-center gap-4">
                    @php
                        $backUrl = $selected_inventaris_id
                            ? route('inventaris.show', $selected_inventaris_id)
                    ...
                    <h2 class="text-xl font-bold text-gray-900 dark:text-white">Catat Riwayat Servis Baru</h2>
                </div>
                ...
                <form action="{{ route('maintenances.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-100 dark:border-gray-700 flex justify-end gap-4">
                        <a href="{{ $backUrl }}"
                            class="px-6 py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-700 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-gray-300 font-medium rounded-xl transition-colors">Batal</a>
                        <button type="submit"
                            class="px-6 py-2.5 bg-orange-600 hover:bg-orange-700 text-white font-bold rounded-xl shadow-lg transition-all">
