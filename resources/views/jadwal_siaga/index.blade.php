...
<x-app-layout>
    <div
        ...
        <div class="container mx-auto px-4 py-8">
            ...
            @if (session('success'))
                <div
                    class="mb-6 p-4 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border border-green-200 dark:border-green-700 rounded-xl">
            ...
            <div
                ...
                <div class="overflow-x-auto">
                    <table class="w-full">
                        <thead>
                            <tr
                                class="bg-gradient-to-r from-slate-50 to-slate-100 dark:from-slate-700 dark:to-slate-600">
                                <th
                                    class="px-6 py-4 text-left text-xs font-semibold text-slate-600 dark:text-slate-300 uppercase tracking-wider border-b border-slate-200 dark:border-slate-600">
                            ...
                            @forelse ($data as $jadwal)
                                <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors duration-150">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-10 w-10">
                                                <div
                                                    class="h-10 w-10 rounded-full bg-gradient-to-r from-red-400 to-red-500 flex items-center justify-center">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        @endphp
                                        <span
                                            class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium {{ $statusColors[$jadwal->status] ?? 'bg-gray-100 text-gray-800 dark:bg-gray-900/30 dark:text-gray-300' }}">
                                            {{ $jadwal->status }}
                                        </span>
                                    </td>
                                    ...
                                    <td colspan="{{ auth()->user()->role === 'admin' ? '4' : '3' }}"
                                        ...
                                        <div class="flex flex-col items-center">
                                            ...
                                            <h3 class="text-lg font-medium text-slate-900 dark:text-slate-100 mb-1">
                                                Belum ada jadwal</h3>
                                            <p class="text-slate-500 dark:text-slate-400">Silakan tambah jadwal siaga
                                                baru</p>
                                        </div>
                                    </td>
                                </tr>
