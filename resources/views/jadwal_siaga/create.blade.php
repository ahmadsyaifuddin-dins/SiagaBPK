        ...
        <div class="container mx-auto px-4 py-8">
            <div class="mb-8">
                <div class="flex items-center space-x-3">
                    <div
                        class="bg-red-500 dark:bg-red-600 p-3 rounded-xl shadow-lg w-12 h-12 flex items-center justify-center">
                    ...
                    <div>
                        ...
                        <p class="text-slate-600 dark:text-slate-400">Buat jadwal baru untuk petugas pemadam kebakaran
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="max-w-2xl mx-auto">
                <div
                    ...
                    <div class="p-8">
                        <form action="{{ route('jadwal_siaga.store') }}" method="POST">
                            @csrf

                            @include('jadwal_siaga._form')

                            <div
                                class="flex items-center justify-between pt-6 border-t border-slate-200 dark:border-slate-700 mt-4">
