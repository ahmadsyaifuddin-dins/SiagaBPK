        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div
                ...
                <div class="p-6 border-b border-gray-200 dark:border-gray-700 flex items-center gap-4">
                    ...
                    <h2 class="text-xl font-bold text-gray-900 dark:text-white">Tambah Data Aset Baru</h2>
                </div>
                ...
                <form action="{{ route('inventaris.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-100 dark:border-gray-700 flex justify-end gap-4">
                        ...
                        <button type="submit"
                            class="px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl shadow-lg transition-all">
