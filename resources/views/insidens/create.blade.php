    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
        <div class="max-w-4xl mx-auto p-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                ...
                <!-- Form -->
                <form action="{{ route('insidens.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
                    @csrf
                    ...
                    <div class="group">
                        ...
                        <textarea name="catatan" id="catatan" rows="4" 
                                  ...
                                  placeholder="Tambahkan catatan detail tentang insiden..."></textarea>
                    </div>
                        ...
                        <div class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-6 text-center hover:border-indigo-400 dark:hover:border-indigo-500 transition-colors duration-200">
                            ...
                            <label for="foto" class="cursor-pointer">
                                ...
                                <p class="text-sm text-gray-600 dark:text-gray-400">
                                    <span class="font-semibold text-indigo-600 dark:text-indigo-400">Klik untuk upload</span> atau drag and drop
                                </p>
                    ...
                    <div class="flex justify-end space-x-3 pt-6 border-t border-gray-200 dark:border-gray-700">
                        ...
                        <button type="submit" 
                                class="px-8 py-3 bg-gradient-to-r from-green-600 to-green-700 
