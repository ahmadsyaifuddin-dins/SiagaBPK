<x-app-layout>
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
        <div class="max-w-4xl mx-auto p-6">
            <!-- Flash Messages -->
            @if (session('success'))
                <div class="mb-6 bg-green-100 dark:bg-green-900/30 border border-green-400 dark:border-green-600 text-green-700 dark:text-green-300 px-4 py-3 rounded-lg shadow-sm animate-pulse" role="alert">
            ...
            @if (session('error'))
                <div class="mb-6 bg-red-100 dark:bg-red-900/30 border border-red-400 dark:border-red-600 text-red-700 dark:text-red-300 px-4 py-3 rounded-lg shadow-sm" role="alert">
                    <div class="flex items-center">
                        <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                ...
                <!-- Form -->
                <form action="{{ route('insidens.update', $insiden) }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
                    @csrf @method('PUT')
                    ...
                    <div class="group">
                        ...
                        <input type="text" name="lokasi" id="lokasi" value="{{ $insiden->lokasi }}"
                    ...
                    <!-- Waktu Kejadian -->
                    <div class="group">
                        <label for="waktu_kejadian" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                            <span class="flex items-center">
                        ...
                        <input type="datetime-local" name="waktu_kejadian" id="waktu_kejadian"
                               value="{{ \Carbon\Carbon::parse($insiden->waktu_kejadian)->format('Y-m-d\TH:i') }}"
                               class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg 
                                      bg-white dark:bg-gray-700 text-gray-900 dark:text-white
                    ...
                    <div class="group">
                        ...
                        <!-- Upload New Photo -->
                        <div class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-6 text-center hover:border-indigo-400 dark:hover:border-indigo-500 transition-colors duration-200">
                            ...
                            <label for="foto" class="cursor-pointer">
                                ...
                                <p class="text-sm text-gray-600 dark:text-gray-400">
                                    <span class="font-semibold text-indigo-600 dark:text-indigo-400">Klik untuk upload foto baru</span> atau drag and drop
                                </p>
                                <p class="text-xs text-gray-500 dark:text-gray-500 mt-1">PNG, JPG, JPEG hingga 2MB</p>
                            </label>
                            <div id="imagePreview" class="mt-4 hidden">
                                <img id="preview" src="" alt="Preview" class="max-w-full h-32 object-cover rounded-lg mx-auto">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-end space-x-3 pt-6 border-t border-gray-200 dark:border-gray-700">
                        <button type="button" onclick="history.back()" 
                                class="px-6 py-3 text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-gray-700 
