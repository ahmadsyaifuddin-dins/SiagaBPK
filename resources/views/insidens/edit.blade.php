    ...
    <div
        ...
        <div class="bg-gradient-to-r from-amber-500 to-orange-600 px-6 py-4">
            <h2 class="text-xl font-bold text-white flex items-center gap-2">
                <i class="fa-solid fa-pen-to-square"></i> Update Data Insiden
            </h2>
        </div>

        <form action="{{ route('insidens.update', $insiden->id) }}" method="POST" enctype="multipart/form-data"
            class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="flex justify-end space-x-3 pt-6 border-t border-gray-200 dark:border-gray-700 mt-6">
                ...
                <button type="submit"
                    class="px-6 py-2.5 bg-amber-600 hover:bg-amber-700 text-white font-semibold rounded-lg shadow-md transition-colors">
                    <i class="fa-solid fa-upload mr-1"></i> Update Data
                </button>
            </div>
        </form>
    </div>
